...
import ChatModel, { ChatDocument } from './modals/ChatSchema'; // MongoDB Schema
...
@injectable()
export class MongoChatRepository extends BaseRepository<Chat, ChatDocument> implements IChatRepository {
  constructor() {
    super(ChatModel);
  }
