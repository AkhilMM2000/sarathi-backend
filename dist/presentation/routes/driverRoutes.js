...
router
    ...
    .get('/dashboard/status-summary', (0, authMiddleware_1.protectRoute)(['driver']), checkBlockedMiddleware.handle.bind(checkBlockedMiddleware), BookingController_1.BookingController.getDriverBookingStatusSummary);
router.get('/dashboard/earnings-summary', (0, authMiddleware_1.protectRoute)(['driver']), checkBlockedMiddleware.handle.bind(checkBlockedMiddleware), BookingController_1.BookingController.getDriverEarningsByMonth);
