...
router
    ...
    .patch(Routes_1.ROUTES.USER.ACKNOWLEDGE_BOOKING, (0, authMiddleware_1.protectRoute)(["user"]), checkBlockedMiddleware.handle.bind(checkBlockedMiddleware), exports.bookingController.acknowledgeBooking.bind(exports.bookingController));
